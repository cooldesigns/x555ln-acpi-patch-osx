 ...
 *
 * Disassembly of SSDT-3.aml, Sat Nov 18 15:33:04 2017
 *
...
DefinitionBlock ("", "SSDT", 2, "Ther_R", "Ther_Rvp", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.H_EC.PECL, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.PENV, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.H_EC.PLMX, UnknownObj)    // (from opcode)
