 ...
 *
 * Disassembly of SSDT-10.aml, Sat Nov 18 15:33:04 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000006F5 (1781)
 *     Revision         0x02
 *     Checksum         0x10
 *     OEM ID           "SgRef"
 *     OEM Table ID     "SgPch"
...
DefinitionBlock ("", "SSDT", 2, "SgRef", "SgPch", 0x00001000)
{
    ...
    External (_SB_.PCI0.RP05.PEGP.NHDA, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.SAT0.SDSM, MethodObj)    // Imported: 4 Arguments
    External (_SB_.PCI0.XHC_.RHUB.TPLD, MethodObj)    // Imported: 2 Arguments
    External (DLHR, FieldUnitObj)    // (from opcode)
    External (DLPW, FieldUnitObj)    // (from opcode)
