 ...
 *
 * Disassembly of DSDT.aml, Sat Nov 18 15:33:04 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00018E79 (102009)
 *     Revision         0x02
 *     Checksum         0x1D
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("", "DSDT", 2, "_ASUS_", "Notebook", 0x01072009)
{
    ...
    External (_SB_.PCI0.IGPU.GCBL, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PCI0.IGPU.GCDS, IntObj)    // (from opcode)
    ...
    External (_SB_.PCI0.IGPU.NATK, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.IGPU.OPTS, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PCI0.IGPU.OWAK, MethodObj)    // 1 Arguments (from opcode)
    External (_SB_.PCI0.IGPU.PRST, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.IGPU.STAT, FieldUnitObj)    // (from opcode)
    External (_SB_.PCI0.IGPU.SWHD, MethodObj)    // 1 Arguments (from opcode)
    ...
    External (_SB_.PCI0.RP05.PEGP.NATK, IntObj)    // (from opcode)
    External (_SB_.PCI0.RP05.PEGP.PRST, IntObj)    // (from opcode)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xAD7BE000, 0x0359)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0xACAB7F18, 0x10)
    ...
    OperationRegion (ABNV, SystemMemory, 0xAD7AD000, 0x0D)
